 ...
 <div data-role="page" id="home">
  ...
  <div data-role="content" id="home">
    <div data-role="collapsible" data-theme="a" data-content-theme="a" data-iconpos="right" data-collapsed="false" >
      ...
      <p> My name is <strong>James <span itemprop="additionalName">Weiluen</span> Huang</strong>. I graduated from the <span itemprop="alumniOf">University of Texas</span> in 2011. Currently I'm a <span itemprop="jobTitle">Peace Corps volunteer in Thailand</span>. I began my service in January of 2012. I can speak English, Chinese, and Thai. If you're interested, you can read about my life here. </p>
    </div>
    ...
    <div data-role="collapsible" data-theme="a" data-content-theme="a" style="font-family: Open Sans, Helvetica, Arial, sans-serif;" data-iconpos="right"> 
      ...
      <blockquote style="font-family: Helvetica, Arial, sans-serif; font-size:14px;"><em> "The opinions, information, and photos found here are solely my own and are in no way affiliated with the Peace Corps or the government of the United States."</em><small><cite title="Me" itemprop="name">James Huang</cite></small></blockquote>
    </div>
    <div data-role="collapsible" data-theme="a" data-content-theme="a" style="font-family: Open Sans, Helvetica, Arial, sans-serif;" data-iconpos="right">
      <h2>CONTACT ME</h2>
...
<div data-role="page" id="blog">
  <div data-role="header" data-position="fixed" class="ui-state-persist">
    <img style="position:relative; left:50%; margin-left:-62.5px; padding: 3px;" src="logos/logo6.png" /> <a style="float: right;" href="#desktop" data-role="button" data-mini="true" class="ui-btn-right"><img src="http://www.weiluen.com/mobile/desktop.png" height="45px" width="45px" style="margin-top:-9px; margin-bottom:-17px; margin-right:-9px; margin-left:-9px;"/></a> </div>
...
<div data-role="page" id="photos">
	  <div data-role="header" data-position="fixed" class="ui-state-persist">
       ...
       <div data-role="content">       		
       		<ul id="Gallery" class="gallery-item">
               <div class="ui-grid-a">
        					<div class="ui-block-a">
                         		<li><a href="images/full/01.jpg" rel="external"><img src="http://www.weiluen.com/mobile/images/thumb/01.jpg" alt="" /></a></li>
                        		<li><a href="images/full/02.jpg" rel="external"><img src="http://www.weiluen.com/mobile/images/thumb/02.jpg" alt="" /></a></li>
                        		<li><a href="images/full/03.jpg" rel="external"><img src="http://www.weiluen.com/mobile/images/thumb/03.jpg" alt="" /></a></li>
                						<li><a href="images/full/04.jpg" rel="external"><img src="http://www.weiluen.com/mobile/images/thumb/04.jpg" alt="" /></a></li>
                						<li><a href="images/full/05.jpg" rel="external"><img src="http://www.weiluen.com/mobile/images/thumb/05.jpg" alt="" /></a></li>
                						<li><a href="images/full/06.jpg" rel="external"><img src="http://www.weiluen.com/mobile/images/thumb/06.jpg" alt="" /></a></li>
                            </div>
                    <div class="ui-block-b">
                              <li><a href="images/full/07.jpg" rel="external"><img src="http://www.weiluen.com/mobile/images/thumb/07.jpg" alt="" /></a></li>
                            <li><a href="images/full/08.jpg" rel="external"><img src="http://www.weiluen.com/mobile/images/thumb/08.jpg" alt="" /></a></li>
                            <li><a href="images/full/10.jpg" rel="external"><img src="http://www.weiluen.com/mobile/images/thumb/10.jpg" alt="" /></a></li>
                            <li><a href="images/full/11.jpg" rel="external"><img src="http://www.weiluen.com/mobile/images/thumb/11.jpg" alt="" /></a></li>
                            <li><a href="images/full/12.jpg" rel="external"><img src="http://www.weiluen.com/mobile/images/thumb/12.jpg" alt="" /></a></li>
                            <li><a href="images/full/13.jpg" rel="external"><img src="http://www.weiluen.com/mobile/images/thumb/13.jpg" alt="" /></a></li>
                   </div>    
                </div>
          </ul>
       </div>
...
<div data-role="page" id="desktop">
    <div data-role="header" data-position="fixed" class="ui-state-persist">
       ...
       <a style="float: right;" href="#desktop" data-role="button" data-mini="true" class="ui-btn-right"><img src="http://www.weiluen.com/mobile/desktop.png" height="45px" width="45px" style="margin-top:-9px; margin-bottom:-17px; margin-right:-9px; margin-left:-9px;"/></a> 
    </div>
       <div data-role="content">
          <h2>DESKTOP</h2>
